...
[NOTE]
Ce script contient la fonction _powmod_ utilisée pour le RSA. Nous n'en avons pas besoin pour les calculs ECDSA.
...
.Vérification de la clé publique d'après la clé privée
